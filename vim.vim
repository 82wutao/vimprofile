...
""let g:airline_section_z      =airline#section#create(['percentage', 'linenr', 'column number'])
""let g:airline_section_error  =airline#section#create(['ycm_error_count', 'syntastic-err', 'eclim', 'languageclient_error_count'])
""let g:airline_section_warning=airline#section#create(['ycm_warning_count', 'syntastic-warn', 'languageclient_warning_count', 'whitespace'])
...
set pythonthreedll="/mingw64/lib/libpython3.9.dll.a"
let g:jedi#auto_initialization = 1
let g:jedi#auto_vim_configuration = 1
let g:jedi#use_tabs_not_buffers = 1 "进入定义，使用tab 而不是buffer"
let g:jedi#use_splits_not_buffers = 'left'  "进入定义，使用split 窗口而不是buffer"
